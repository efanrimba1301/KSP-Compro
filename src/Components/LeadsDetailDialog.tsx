...
type EditableField = 'company' | 'email' | 'whatsapp' | 'budget_range' | 'heard_from' | 'project_detail'
...
export function LeadDetailDialog({
    ...
    const commitFieldIfChanged = async (field: EditableField, value: string) => {
        ...
        try {
            ...
            const toastId = toast.success(`${fieldLabels[field]} berhasil diperbarui`, {
                ...
                action: {
                    label: 'Undo',
                    // e.preventDefault() → cegah sonner auto-dismiss toast saat Undo diklik
                    // sehingga dialog tetap terbuka & nilai form bisa dikembalikan terlebih dahulu
                    onClick: (e) => {
                        e.preventDefault()
            ...
            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-1">
                    ...
                    <div className="flex flex-col">
                        ...
                        {/* Service Required — read only, dari database (array) */}
                        <DetailRow icon={SourceCodeSquareIcon} label="Service Required">
                            <div className="flex flex-wrap gap-1.5">
                                {lead.services_required.map((service) => (
                        ...
                        <EditableInputRow
                            ...
                            onChange={(v) => handleFieldChange('budget_range', v)}
                            onToggleEdit={() => handleToggleEdit('budget_range')}
                        />
